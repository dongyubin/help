# Just My Socks:搬瓦工官方2026最新翻墙服务，多条线路，IP不怕被墙，支持ChatGPT

[点我跳转Just My Socks 懒人版](justmysocks.md#just-my-socks-lan-ren-ban)
...
* **支持的协议：TCP或UDP？** Just My Socks 100 仅支持 TCP 协议，该协议足以用于浏览网络以及使用YouTube等大多数流媒体服务。从 Just My Socks 500 开始的所有套餐均支持 TCP 和 UDP 协议（请参阅下面的注释）。语音协议（如 WhatsApp 和某些 VOIP 实现）可能需要 UDP 协议。如果您的套餐是Just My Socks 100，并且您想使用 UDP 协议，那么您将需要升级到 Just My Socks 500 套餐。
...
然后在相关支持订阅方式配置节点的客户端粘贴此条订阅链接即可完成配置，在 [客户端](justmysocks.md#ke-hu-duan) 添加完后需要进行更新订阅链接操作。

### 订阅链接高级配置技巧

* 如果只想自动配置 [V2Ray](justmysocks.md#ke-hu-duan)，那么就在上图订阅链接处的链接最后加上 `&noss=1`。
* 如果只想自动配置 [Shadowsocks](justmysocks.md#ke-hu-duan)，那么就在上图订阅连接处的链接最后加上 `&novmess=1`。
...
<img src="https://usacdn.wangdu.site/file/blog-cdn/WP-CDN-02/2024/202406271021622.webp" alt="justmysocks服务器信息" data-size="original">
...
* [Shadowsock 客户端](free-shadowrocket.md#windowsmacosandroidios-ke-hu-duan)
* [ShadowsocksR 客户端](free-shadowrocket.md#windowsmacosandroidios-ke-hu-duan)
* [V2Ray 客户端](free-shadowrocket.md#windowsmacosandroidios-ke-hu-duan)
...
把3个不同域名的订阅链接全部加入到软件中，更新节点时候全部更新；然后测试可用节点即可。

**方法2：自建1个节点用来更新订阅链接**

自建节点只用来特殊时候更新购买的订阅链接服务器节点，平常不用自建节点流量。

#### 订阅链接被人知道怎么办

如果你的订阅链接不小心被别人知道，或者你就是想换个新的订阅链接，那么很简单，只要在**网页后台修改下你的这个套餐链接的密码**就可以了。

### Clash托管配置文件格式不正确: yaml: unmarshal errors:line 1: cannot unmarshal !!str c3M6Ly9...into config.RawConfig

直接把搬瓦工的订阅链接放在clash里面下载的话是无法使用的，正确方式是，使用其他的配置方式或者将搬瓦工jms的订阅链接经过转换才能使用，可以使用这个网站进行转换：[https://acl4ssr-sub.github.io/ ](https://acl4ssr-sub.github.io/)或者下载对应客户端转换 [https://github.com/tindy2013/subconverter/releases](https://github.com/tindy2013/subconverter/releases)。
